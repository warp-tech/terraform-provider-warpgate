...
Password credentials can be imported using a combined ID with the format `user_id:credential_id`. Note that when importing a password credential, the password itself cannot be retrieved from Warpgate and must be specified in configuration if managing state.

### Declarative Import Block (Terraform 1.5+ / OpenTofu 1.6+)

```hcl
import {
  to = warpgate_password_credential.eugene_password
  id = "12345678-1234-1234-1234-123456789012:87654321-4321-4321-4321-210987654321"
}
```
...
# Using OpenTofu CLI
tofu import warpgate_password_credential.eugene_password 12345678-1234-1234-1234-123456789012:87654321-4321-4321-4321-210987654321
```

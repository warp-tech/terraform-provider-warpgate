...
```hcl
import {
  to = warpgate_user_sso_credential.example
...
# Using OpenTofu CLI
tofu import warpgate_user_sso_credential.example 12345678-1234-1234-1234-123456789012:87654321-4321-4321-4321-210987654321
```

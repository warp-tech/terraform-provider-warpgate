...
Tickets can be imported using their ID.

### Declarative Import Block (Terraform 1.5+ / OpenTofu 1.6+)

```hcl
import {
  to = warpgate_ticket.example
...
```shell
# Using Terraform CLI
terraform import warpgate_ticket.example 12345678-1234-1234-1234-123456789012

# Using OpenTofu CLI
tofu import warpgate_ticket.example 12345678-1234-1234-1234-123456789012
```

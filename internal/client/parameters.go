...
type ParameterValues struct {
	...
	MfaPolicyExemptSsoUsers          bool                         `json:"mfa_policy_exempt_sso_users"`
	DefaultCredentialPolicy          UserRequireCredentialsPolicy `json:"default_credential_policy"`
	...
	RecordDesktopKeyboardInput       bool                         `json:"record_desktop_keyboard_input"`
	...
	AdminApprovalTimeoutSeconds      int64                        `json:"admin_approval_timeout_seconds,omitempty"`
	AdminApprovalGracePeriodSeconds  int64                        `json:"admin_approval_grace_period_seconds,omitempty"`
...
type ParametersUpdateRequest struct {
	...
	MfaPolicyExemptSsoUsers          *bool                         `json:"mfa_policy_exempt_sso_users,omitempty"`
	DefaultCredentialPolicy          *UserRequireCredentialsPolicy `json:"default_credential_policy,omitempty"`
	...
	RecordDesktopKeyboardInput       *bool                         `json:"record_desktop_keyboard_input,omitempty"`
